...
# CRITICAL EXPERIENCE PARSING REQUIREMENTS:
# - When job requirements mention experience ranges like "2–6 years", "2-6 years", or "2 to 6 years", interpret as MINIMUM 2 years and MAXIMUM 6 years
# - Do NOT concatenate range numbers (e.g., "2–6" should NOT become "26")
# - Extract candidate's ACTUAL experience duration from CV content only
# - Match language appropriately to candidate's real experience level, not inflated ranges
# - Common experience formats to recognize correctly:
#   * "X–Y years" (en dash) = range from X to Y
#   * "X-Y years" (hyphen) = range from X to Y  
#   * "X to Y years" = range from X to Y
#   * "X+ years" = minimum X years
#   * "X years+" = minimum X years

# STRICT OUTPUT RULES:
# - Use *only* achievements, projects, or skills present in CV
# - Extract ACTUAL years of experience from CV (e.g., "1.5 years", "3 years") 
...
# EXPERIENCE CALIBRATION EXAMPLES:
# ✓ Correct: "With 1.5 years of Java development experience from XYZ Corp, I align with your software development needs."
# ✗ Wrong: "With 26 years of experience as a Java Software Developer..." (when CV shows 1.5 years)

# ✓ Correct: "My 3 years of Spring Boot experience demonstrates solid proficiency with your required frameworks."
# ✗ Wrong: "My extensive decades of Spring Boot expertise..." (when CV shows 3 years)

# REALISTIC ACHIEVEMENT FRAMING:
# - If CV shows junior-level experience, use appropriate language: "contributed to", "participated in", "assisted with"
# - If CV shows mid-level experience, use: "developed", "implemented", "managed"
# - If CV shows senior experience, use: "led", "architected", "established"

# VALIDATION REQUIREMENTS:
# - All experience claims must be traceable to CV content
# - Experience duration must match CV documentation exactly
# - Professional language must align with actual experience level
# - No fabrication of achievements or inflated timeframes
# - Technology mentions must exist in CV
...
# EXAMPLE (when evidence exists - mid level):
# "My 4 years of Java development experience, including 2 years with Spring Boot at XYZ Corp, directly matches your technical requirements. I successfully implemented REST APIs and managed database integrations for enterprise applications. This proven track record enables me to immediately contribute to your software development objectives."
...
# EXPERIENCE PARSING REQUIREMENTS:
# - When job description mentions experience ranges like "2–6 years", "2-6 years", or "2 to 6 years", interpret as MINIMUM 2 years and MAXIMUM 6 years
# - Do NOT concatenate range numbers (e.g., "2–6" should NOT become "26")
# - Common experience formats to recognize:
#   * "X–Y years" (en dash)
#   * "X-Y years" (hyphen) 
#   * "X to Y years"
#   * "X+ years" (minimum X years)
#   * "X years+" (minimum X years)
# - Match candidate's actual experience level to the job requirements appropriately
...
# - Compare with job requirement range (e.g., 2-6 years means 2 minimum, 6 maximum)
...
# - Action verbs appropriate to actual experience level from CV
...
# STRICTLY FORBIDDEN:
# - Misinterpreting experience ranges (e.g., treating "2-6 years" as "26 years")
# - Adding metrics not present in CV content
# - Inflating experience duration beyond CV documentation
# - Creating achievements not mentioned in CV
# - Using senior-level language for junior candidates
# - Adding technologies or skills not listed in CV
# - Claiming extensive experience without CV evidence
# - Exaggerating project scale beyond CV information
# - Generic percentage improvements without CV basis

# CREDIBILITY PROTECTION:
# - If CV shows 1.5 years experience and job requires 2-6 years, position as "approaching the experience range"
...
# - Frame experience positively but accurately within actual timeframe

# REALISTIC ACHIEVEMENT FRAMING:
# Instead of: "Enhanced system performance by 30%" 
# Use: "Contributed to system optimization through SQL query improvements"

# Instead of: "Led cross-functional teams" (if not documented)
# Use: "Collaborated effectively with cross-functional teams"

# Instead of: "Extensive experience in..." (for 1-2 years)
...
# 8. Experience ranges parsed correctly (2-6 means range, not 26)
