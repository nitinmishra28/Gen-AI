...
#         top_p = top_p if top_p is not None else model_config.get('top_p', 1.0) # Fallback to 1.0 if not set

            
#         logger.debug(f"Calling LLM API with model: {model_name}, temp: {temperature}, top_p: {top_p}")
#         params = {
#             "model": model_name,
#             "messages": [
